				...
				<ul class="contact_details">
					<?php
						...
						if( $header_phone = mfn_opts_get( 'header-phone' ) ){
							echo '<li class="phone"><i class="icon-call"></i><a href="tel:'. str_replace(' ', '', $header_phone) .'">'. $header_phone .'</a></li>';
						}
						if( $header_phone_2 = mfn_opts_get( 'header-phone-2' ) ){
						    echo '<li class="separator"><a></a></li>';
							echo '<li class="phone"><a href="tel:'. str_replace(' ', '', $header_phone_2) .'">'. $header_phone_2 .'</a></li>';
						}
